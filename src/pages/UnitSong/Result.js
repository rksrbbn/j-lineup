        ...
        <div style={{ backgroundColor: '#FDECEF', minHeight: '100vh', marginTop: 0, display: 'flex', flexDirection: 'column' }}>
            ...
            <Container className="App" maxWidth="sm">
                ...
                <div style={{ display: 'flex', justifyContent: 'center', marginTop: '50px', gap: '10px' }}>
                    <Button fullWidth variant='outlined' color='error' onClick={backToUnitSong}>CREATE NEW LINEUP</Button>
                    <Button fullWidth variant='outlined' color='error' onClick={backToHome}>BACK TO HOME</Button>
                </div>
            </Container>
            <FooterApp />
        </div>
